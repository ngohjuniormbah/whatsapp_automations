-- ============================================================
-- wacrm — FULL DATABASE SCHEMA (all migrations 001–039)
...
--   3. Click Run
--
-- Safe to re-run: every migration uses IF NOT EXISTS / idempotent
-- guards. Run it top to bottom in one go.
-- ============================================================
